...
FEATURES="vih_ad_push vih_calendar vih_commerce vih_core vih_dashboard vih_employees vih_facilities vih_golf_courses vih_images vih_landing_pages vih_lectures vih_long_course vih_participant_quotes vih_short_course vih_short_course_commerce vih_short_course_family vih_short_course_kayak vih_short_course_sport vih_stories vih_student_quotes vih_subjects vih_viggo"
